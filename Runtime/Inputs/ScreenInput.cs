...
namespace NatML.Recorders.Inputs {
    ...
    public sealed class ScreenInput : IDisposable {
        ...
        public ScreenInput (IMediaRecorder recorder, IClock clock = default) : this(CreateInput(recorder), clock) { }
        ...
        /// <param name="clock">Recording clock for generating timestamps.</param>
        public ScreenInput (ITextureInput input, IClock clock = default) {
            this.input = input;
            this.clock = clock;
